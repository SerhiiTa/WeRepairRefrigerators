...
export function PublicHeroSection({
  ...
  return (
    <section
      className={
        isLight
          ? "border-b border-blue-100 bg-[linear-gradient(135deg,#f8fbff_0%,#eef7ff_48%,#ffffff_100%)]"
    ...
    >
      <div className="mx-auto max-w-7xl px-6 py-14 sm:py-16 lg:py-20">
        ...
        <h1
          className={
            isLight
              ? "mt-5 max-w-4xl text-4xl font-black tracking-tight text-slate-950 md:text-6xl"

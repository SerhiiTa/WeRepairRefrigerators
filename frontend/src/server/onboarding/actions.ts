...
export async function updateTechnicianProfile(
  ...
  const { data, error } = await supabase.rpc(
    "upsert_own_technician_profile_rpc",
    {
      ...
      p_appliance_categories: updatePayload.appliance_categories,
      p_avatar_color: updatePayload.avatar_color,
      p_brands_serviced: updatePayload.brands_serviced,
      p_marketplace_enabled: updatePayload.marketplace_enabled,
      p_service_cities: updatePayload.service_cities,
